...
int main(){
    ...
    superPoder1 = populacao1 + area1 + PIB1 + calculoPIB1 + ((calculoDensidade1 * (-1))) + p_turisticos1;
    superPoder2 = populacao2 + area2 + PIB2 + calculoPIB2 + ((calculoDensidade2 * (-1))) + p_turisticos2;
